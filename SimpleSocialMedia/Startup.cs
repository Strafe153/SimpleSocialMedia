...
using SimpleSocialMedia.Repositories.Implementations;
...
namespace SimpleSocialMedia
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUsersControllable, UsersRepository>();
            services.AddScoped<IPostsControllable, PostsRepository>();
